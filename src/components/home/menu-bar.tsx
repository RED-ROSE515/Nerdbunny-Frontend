        ...
        {menuItems.map((item, index) => (
          <motion.li key={item.label} className='relative'>
            ...
            >
              ...
              <motion.a
                href={item.href}
                className='absolute inset-0 z-10 flex items-center gap-2 rounded-xl bg-transparent px-4 py-2 text-muted-foreground transition-colors group-hover:text-foreground'
