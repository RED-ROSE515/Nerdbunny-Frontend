...
export function PaperGlobe() {
  ...
  return (
    <div className='relative flex h-[55vh] w-full flex-row items-center justify-center md:h-auto md:py-20'>
      <div className='relative mx-auto h-full w-full max-w-7xl overflow-hidden px-4 md:h-[45rem]'>
        <motion.div
          initial={{
            opacity: 0,
            y: 20
        ...
        >
          <h2 className='text-center text-xl font-bold text-black dark:text-white md:text-4xl'>
            Check with WorldWide Research Papers.
          </h2>
        </motion.div>
        ...
        <div className='absolute z-10 h-72 w-full md:-bottom-20 md:h-full'>
